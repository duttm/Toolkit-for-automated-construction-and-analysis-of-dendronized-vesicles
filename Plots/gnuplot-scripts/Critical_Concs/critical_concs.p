...
set output filename.'_all_gens.png'
...
set xlabel "Concentration of Dendrons" font "Times-New-Roman,12" offset -1,0.5 
...
plot 'critical_concs.txt'  using  (($2/3039)*100):($1) with linespoints linestyle 1 title "Acidic", 'critical_concs.txt'  using  (($4/3039)*100):($1) with linespoints linestyle 3 title "Neutral", 'critical_concs.txt'  using  (($3/3039)*100):($1) with linespoints linestyle 5 title "Basic"
