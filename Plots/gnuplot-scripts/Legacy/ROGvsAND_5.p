...
set xlabel "Number of Dendron Beads" font "Times-New-Roman,12" offset -1,0.5 
...
plot '../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  (a1*$2):(2*$5) with linespoints linestyle 1 title "G1-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  (a1*$2):($3) with linespoints linestyle 2 title "G1-AND", \
 '../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  (a2*$2):(2*$5) with linespoints linestyle 3 title "G2-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  (a2*$2):($3) with linespoints linestyle 4 title "G2-AND", \
 '../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  (a3*$2):(2*$5) with linespoints linestyle 5 title "G3-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  (a3*$2):($3) with linespoints linestyle 6 title "G3-AND", \
 '../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  (a4*$2):(2*$5) with linespoints linestyle 7 title "G4-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  (a4*$2):($3) with linespoints linestyle 8 title "G4-AND", \
 '../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  (a5*$2):(2*$5) with linespoints linestyle 9 title "G5-2ROG" ,\
