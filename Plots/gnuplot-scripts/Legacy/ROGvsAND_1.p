...
set output filename.ph.'_G1_G5.png'
...
plot '../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  ($2):(2*$5) with linespoints linestyle 1 title "G1-2ROG" ,\
 ...
 '../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  ($2):(2*$5) with linespoints linestyle 5 title "G5-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  2:($3) with linespoints linestyle 6 title "G5-AND", \
