...
plot '../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  ($2):(2*$5) with linespoints linestyle 1 title "G1-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  2:($3) with linespoints linestyle 2 title "G1-AND", \
 
 

set label 1 '(B)'
plot '../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  ($2):(2*$5) with linespoints linestyle 3 title "G2-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  2:($3) with linespoints linestyle 4 title "G2-AND", \
 
set label 1 '(C)' 
plot '../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  ($2):(2*$5) with linespoints linestyle 5 title "G3-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  2:($3) with linespoints linestyle 6 title "G3-AND", \
 
set label 1 '(D)' 
plot '../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  ($2):(2*$5) with linespoints linestyle 7 title "G4-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  2:($3) with linespoints linestyle 8 title "G4-AND", \
 
set label 1 '(E)' 
plot '../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  ($2):(2*$5) with linespoints linestyle 9 title "G5-2ROG" ,\
 '../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  2:($3) with linespoints linestyle 10 title "G5-AND", \
