...
yaxis = "Outer dendrons / Inner dendrons"
...
set label 1 '(B)'
plot '../../DATA/'.ph2.'/'.filename.'/SummaryG1.txt'  using  (a1*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "black" linewidth 3 not,\
...
set label 1 '(D)'
plot '../../DATA/'.ph2.'/'.filename.'/SummaryG2.txt'  using  (a2*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "red" linewidth 3 not,\
...
set label 1 '(F)'
plot '../../DATA/'.ph2.'/'.filename.'/SummaryG3.txt'  using  (a3*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "blue" linewidth 3 not,\
...
set label 1 '(H)' 
plot '../../DATA/'.ph2.'/'.filename.'/SummaryG4.txt'  using  (a4*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "#005A32" linewidth 3 not,\
...
set label 1 '(J)'   
plot '../../DATA/'.ph2.'/'.filename.'/SummaryG5.txt'  using  (a5*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "violet" linewidth 3 not,\
