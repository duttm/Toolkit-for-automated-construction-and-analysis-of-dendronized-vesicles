...
filename = "DHS_allDENbeads"

yaxis = "Fraction of Surface Area Covered"

set output filename.'_all_Mw.png'

set term post portrait enhanced color 

set terminal pngcairo  enhanced font "Times New Roman,14" fontscale 1.0 size 800, 550
