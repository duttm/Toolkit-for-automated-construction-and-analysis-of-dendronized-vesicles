...
yaxis = "Inner Dendrons"

set output filename.'_all.png'

set term post portrait enhanced color 

set terminal pngcairo  enhanced font "Times New Roman,14" fontscale 1.0 size 1000, 650
...
set xlabel "Mw of Dendrons" font "Times-New-Roman,16" offset -1,0.5 
