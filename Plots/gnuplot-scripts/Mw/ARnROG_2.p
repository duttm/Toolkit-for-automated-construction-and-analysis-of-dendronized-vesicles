...
f(x) = m * x + q     
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  (log(a1*$2)):(log($3/$5)) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  (log(a2*$2)):(log($3/$5)) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  (log(a3*$2)):(log($3/$5)) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  (log(a4*$2)):(log($3/$5)) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  (log(a5*$2)):(log($3/$5)) via m, q
