...
set output filename.'_all_Mw_split.png'
...
plot '../../DATA/ACIDIC/'.filename.'/SummaryG1.txt'  using  (a1*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "black" linewidth 3 not,\
 ...
 '../../DATA/BASIC/'.filename.'/SummaryG1.txt'  using  (a1*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "black" linewidth 3 not,\
...
set label 1 '(C)'  
plot  '../../DATA/ACIDIC/'.filename.'/SummaryG3.txt'  using  (a3*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "red" linewidth 3 not,\
...
set label 1 '(D)'  
plot   '../../DATA/ACIDIC/'.filename.'/SummaryG4.txt'  using  (a4*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "violet" linewidth 3 not,\
...
set label 1 '(E)'  
plot  '../../DATA/ACIDIC/'.filename.'/SummaryG5.txt'  using  (a5*$2):($3):($4) with yerrorbars ls 7 ps 0.1 lt rgb "blue" linewidth 3 not,\
