...
plot '../../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  (($2*100)/3039):($3/$5) with linespoints linestyle 2 title "G1", \
 '../../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  (($2*100)/3039):($3/$5) with linespoints linestyle 4 title "G2", \
 '../../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  (($2*100)/3039):($3/$5) with linespoints linestyle 6 title "G3", \
 '../../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  (($2*100)/3039):($3/$5) with linespoints linestyle 8 title "G4", \
 '../../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  (($2*100)/3039):($3/$5) with linespoints linestyle 10 title "G5", \
