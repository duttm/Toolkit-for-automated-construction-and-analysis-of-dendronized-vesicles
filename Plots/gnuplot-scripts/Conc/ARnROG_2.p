...
f(x) = m * x + q     
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG1.txt'  using  (($2*100)/3039):($3/$5) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG2.txt'  using  (($2*100)/3039):($3/$5) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG3.txt'  using  (($2*100)/3039):($3/$5) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG4.txt'  using  (($2*100)/3039):($3/$5) via m, q
fit f(x) '../../DATA/'.ph.'/'.filename.'/SummaryG5.txt'  using  (($2*100)/3039):($3/$5) via m, q
