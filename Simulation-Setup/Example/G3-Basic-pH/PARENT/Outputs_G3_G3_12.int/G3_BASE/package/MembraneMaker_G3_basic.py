...
# execution style : python MembraneMaker_*_*.py
...
# sample run : python3 MembraneMaker_*_*.py dppc_3002.gro 1 36468 12 1 4 den_up_G2.gro 1 31 31 den_down_G2.gro 1 31 31 1
...
#######################################################################################                    
    ...
    for i in range(rows):
        ...
        if i <31:  ## Need to change the X in " rows - X " for other dendrons !!
