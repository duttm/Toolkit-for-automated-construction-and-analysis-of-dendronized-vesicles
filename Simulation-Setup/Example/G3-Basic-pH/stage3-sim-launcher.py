...
directory = "Vesicle_Start"

target_file = "12-input.gro"
...
test_interactive_script="hpc_tester.bash"
...
for i in range(len(list)): 
    ...
    if Generation in list[i]:
        ...
        try:
            ...
            if int(name) == 1:
                subprocess.check_call([exec_arg_1, TOP, ITP])
            elif int(name) == 2:
                subprocess.check_call([exec_arg_1, TOP, ITP, Generation])
