    ...
    for k in range(pages):
        ...
        for l in range(up_count):
            ...
            for i in range(rows):
                ...
                new_den[h][3][k] = den[i][3][k] - (den[0][3][k] - array4d[3][3][temp_s][k])
                h = h + 1
    ...
    for k in range(pages):
        ...
        for l in range(low_count):
            ...
            for i in range(rows):
                ...
                new_den[h][3][k] = den_down[i][3][k] - (den_down[0][3][k] - array4d[3][3][temp_s][k])
                h = h + 1
...
#######################################################################################                    
    ...
    for i in range(rows):
        ...
        if i == 0:  ## Need to change the X in " rows - X " for other dendrons !!
        ...
        elif i == 2:  ## Need to change the X in " rows - X " for other dendrons !!
