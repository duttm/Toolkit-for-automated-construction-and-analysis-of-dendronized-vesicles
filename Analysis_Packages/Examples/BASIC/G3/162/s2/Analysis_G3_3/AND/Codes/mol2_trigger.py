...
def mol2_reader(filename, COM, rad, mean):
...
##################################################################################
    ...
    [uprad, upcount, lorad, locount, expelled, status] = radius_mol2(rad, mean, COM, array_4D, filename, NOF, a, size, args[2], args[3], args[4])
