...
nameofstudy="DHS_TAbeads" 
Analysis="Dendron_Projected_area_TAbeads.out"
        ...
        for k in range(nos):
            ...
            if isExist:
                ...
                for x in lines:
                    ...
                    single_spaces = " ".join(x.split())
                    AND.append(float(single_spaces.split(' ')[0].strip()))
                
                    ##AND.append(float(x.split('\t')[1].strip()))
                f2.close()    
