...
def radius_mol2(rad, mean, COM, array_4D, filename, NOF, a, size, outfile, moleculefile, indexing, margin):
    array = array_4D
    s1 = int(a / size)
    ...
    return upradius, upcount, loradius, locount, expelled, status
